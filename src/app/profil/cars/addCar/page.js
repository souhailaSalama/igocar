        ...
        <div className="rounded-lg sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center mx-auto">
            <form className="text-center" onSubmit={handelSubmit}>
                ...
                <div className="py-2">
                    ...
                    <Link href="/profil/cars" className='border-2 border-gray-100 focus:outline-none bg-red-600 text-white font-bold tracking-wider block w-full p-2 rounded-lg focus:border-gray-700 hover:bg-red-700'>Annuler</Link>
                </div>
            </form>
        </div>
    )
