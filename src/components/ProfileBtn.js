...
export default function ProfileBtn({ userName }) {
    ...
    return (
        <div className="flex algin-center">
            ...
            <button className='ml-2' onClick={handelLogout}>
                <span >
                    <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" fill="#9333EA" height="15px" width="15px" version="1.1" id="Capa_1" viewBox="0 0 384.971 384.971" space="preserve">
                        <g id="Sign_Out">
